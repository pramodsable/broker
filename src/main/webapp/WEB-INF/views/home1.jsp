	...
	<div class="w3-top">
		<div class="w3-bar w3-black w3-card">
			<a
				...
				href="#band"
				class="w3-bar-item w3-button w3-padding-large w3-hide-small">BUY</a>
			<a href="#tour"
				class="w3-bar-item w3-button w3-padding-large w3-hide-small">SELL</a>
			<a href="#contact"
				class="w3-bar-item w3-button w3-padding-large w3-hide-small">RENT</a>
			<a href="#contact"
				class="w3-bar-item w3-button w3-padding-large w3-hide-small">LOGIN</a>
			<a href="#contact"
				class="w3-bar-item w3-button w3-padding-large w3-hide-small">CONTACT
				US</a>
			<div class="w3-dropdown-hover w3-hide-small">
				...
				<div class="w3-dropdown-content w3-bar-block w3-card-4">
					<a href="#" class="w3-bar-item w3-button">ABOUT US</a> <a href="#"
						class="w3-bar-item w3-button">Extras</a> <a href="#"
...
<img src="<c:url value='/resources/images/home_img_2.jpg' />"
		...
		<div class="w3-container w3-content w3-center w3-padding-64"
			...
			<div class="w3-row w3-padding-32">
				<div class="w3-third">
					<p>Appartments</p>
					<img src="home_img_1.jpg" class="w3-round w3-margin-bottom"
						alt="Random Name" style="width: 60%">
				</div>
				<div class="w3-third">
					<p>Row Houses</p>
					<img src="home_img_2.jpg" class="w3-round w3-margin-bottom"
						alt="Random Name" style="width: 60%">
				</div>
				<div class="w3-third">
					<p>Plotes</p>
					<img src="home_img_3.jpg" class="w3-round" alt="Random Name"
						style="width: 60%">
				</div>
			</div>
		</div>
		...
		<div class="w3-black" id="tour">
			<div class="w3-container w3-content w3-padding-64"
				...
				<p class="w3-opacity w3-center">
					<i>Remember to register your name!</i>
				</p>
				<br>
				...
				alt="...2" class="img-thumbnail">
						<div class="w3-container w3-white">
							...
							<button class="w3-button w3-black w3-margin-bottom"
								onclick="document.getElementById('ticketModal').style.display='block'">Register
								Now</button>
						</div>
					</div>
					<div class="w3-third w3-margin-bottom">
						<img src="<c:url value='/resources/images/home_img_2.jpg' />"
				alt="...2" class="img-thumbnail">		<div class="w3-container w3-white">
							<p>
								<b>Pune</b>
							</p>
					...
					<div class="w3-third w3-margin-bottom">
						<img src="home_img_3.jpg" alt="Aurangabad" style="width: 100%"
		...
		<div class="w3-container w3-content w3-padding-64"
			...
			<div class="w3-row w3-padding-32">
				<div class="w3-col m6 w3-large w3-margin-bottom">
					<i class="fa fa-map-marker" style="width: 30px"></i> Maharashtra
					Real Estate,Maharashtra, INDIA<br> <i class="fa fa-phone"
						style="width: 30px"></i> Phone: +91 7875326861<br> <i
						class="fa fa-envelope" style="width: 30px"> </i> Email:
					maharashtrarealestate@gmail.com<br>
				</div>
				<div class="w3-col m6">
...
-->
	...
	<p class="w3-medium">
		Powered by <a href="https://www.w3schools.com/w3css/default.asp"
			target="_blank">Patil's It Solutions</a>
	</p>
	</footer>
